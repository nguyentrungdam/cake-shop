...
import { getProductsByCategorySlug } from "../../../../slices/productSlice";
...
export default function PageCategoryProducts() {
  ...
  useEffect(() => {
    const fetchProductByCategory = () => {
      dispatch(getProductsByCategorySlug(slug.slug)).unwrap();
    }
        ...
        <div className="page_products_main">
          ...
          <div className="page_products_list_product">
            {productList.length === 0 && loading === false ?
              <div className="page_products_list_product_none">
                <div className="productIsLoading">Không có sản phẩm</div>
              </div> :
